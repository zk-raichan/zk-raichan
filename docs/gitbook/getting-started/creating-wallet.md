...
- [ ] Public address copied and saved
- [ ] Shielded address noted
- [ ] Initial balance checked
- [ ] CLI commands tested
...
**Previous:** [Installation & Setup](./installation.md) | **Next:** [Understanding Addresses](./understanding-addresses.md)
# Getting Started with ZK-RAICHAN

Welcome to ZK-RAICHAN, the privacy protocol for Solana blockchain!
...
```bash
git clone https://github.com/raichan-protocol/zk-raichan.git
cd zk-raichan
```
...
- Join our [Discord Community](https://discord.gg/raichan)
